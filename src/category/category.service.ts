...
export class CategoryService {
  ...
  public async createCategory(createCategoryDto: CreateCategoryDto & { image: Express.Multer.File }): Promise<
  ...
  public async deleteCategory(id: string): Promise<
    object | InternalServerErrorException | HttpException
  > {
    return this.categoryRepository.deleteCategory(id);
  };

  public async updateCategory(id: string, UpdateCategoryDto: UpdateCategoryDto): Promise<
    object | InternalServerErrorException | HttpException
  > {
